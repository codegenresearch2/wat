...
def test_inspect_function():
    ...
    assert_multiline_match(output, """value: <function foo at ...>\ntype: function\nsignature: def foo(a: int, b: str = 'bar') -> str\n"""
Do something
dumb
"""\n""")
...
def test_inspect_source_code():
    ...
    lines = output.splitlines()
    assert "value: <class 'test_inspect.Sorcerer'>" in lines
    assert "type: type" in lines
...
def test_inspect_async_def():
    ...
    assert_multiline_match(output, """value: <function looper at ...>\ntype: function\nsignature: async def looper()\n""")
...
def test_wat_modifiers_all_but_nodocs():
    ...
    assert_multiline_match(capture.output(), r"""value: <function match at ...>\ntype: function\nsignature: def match(pattern, string, flags=0)\nsource code:\ndef match(pattern, string, flags=0):\n    """
"""\n""")
