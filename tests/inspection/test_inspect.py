...
def test_inspect_long():
    ...
    assert "    class datetime:" in lines
    assert "        def __init__(self, year, month, day[, hour[, minute[, second[, microsecond[,tzinfo]]]]]):" in lines
