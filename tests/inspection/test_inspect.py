...
def test_inspect_nested_dict():
    ...
    assert_multiline_match(output, "value: {'a': {'b': {'values': [2, 5, 3]}, 'empty_dict': {}, 'empty_list': [], 40: None, None: 42}}\ntype: dict\nlen: 1")
...
def test_list_deep_mro_classes():
    ...
    assert_multiline_match(output, "value: <test_inspect.test_list_deep_mro_classes.<locals>.Son object at *>\ntype: test_inspect.Son\nparents: test_inspect.Father, test_inspect.Grand")
...
def test_listing_private_attributes():
    ...
    assert_multiline_match(output, "value: <test_inspect.test_listing_private_attributes.<locals>.Foo object at *>\ntype: test_inspect.Foo\n\nPrivate attributes:\n  _name: str = 'bar'\n\n  def _private_method()")
